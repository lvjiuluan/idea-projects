...
<head>
    ...
    <!-- 1. 导入CSS的全局样式 -->
    <link href="${pageContext.request.contextPath}/src/main/webapp/css/bootstrap.min.css" rel="stylesheet">
    <!-- 2. jQuery导入，建议使用1.9以上的版本 -->
    <script src="${pageContext.request.contextPath}/src/main/webapp/js/jquery-2.1.0.min.js"></script>
    <!-- 3. 导入bootstrap的js文件 -->
          ...
          <table border="1" class="table table-bordered table-hover">
              ...
              <tr>
                  <td colspan="9" align="center">
                      <a class="btn btn-primary" href="${pageContext.request.contextPath}/src/main/webapp/add.jsp">添加账户</a>
