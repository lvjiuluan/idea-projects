...
\begin{table}[h]
	...
	\begin{tabular}{p{3cm}p{9cm}}
		...
		\makecell[r]{\songti\xiaosid 指导教师}	& \makecell[c]{\songti\bfseries\sanhaod  \quad \quad \, 韦庆杰 \quad \, \qquad 正高级工程师} \\
		\cline{2-2}
		&  \makecell[c]{\songti\bfseries\sanhaod \quad \, 刘\hspace{16pt}歆 \quad \quad \quad \, \qquad 副教授}\\ 
		\cline{2-2}
	\end{tabular}
\end{table}
