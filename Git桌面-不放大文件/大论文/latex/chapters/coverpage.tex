...
%输入论文题目如果过长可以在第二行进行输入，如果不需要第二行请自行删除，注意字体里面的\xiaoerd表示的是单倍行距，在封面页各种字体后面都加一个d 
			...
			\makecell[c]{\songti\bfseries\xiaoerd 论文题目}	& \makecell[c]{\songti\bfseries\xiaoerd 基于联邦半监督学习的} \\ 
			\cline{2-2}
			 	&  \makecell[c]{\songti\bfseries\xiaoerd 样本生成方法研究}\\ 
			\cline{2-2}
			\end{tabular}
	\end{table}
...
\dlmu[14cm]{\songti\xiaoerd\bfseries 基于联邦半监督学习的样本生成方法研究}\\
\vspace{5mm}
%请在此输入作者姓名
